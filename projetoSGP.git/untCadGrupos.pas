...
begin
  ...
  TfrmMenssagens.Mensagem('Desculpe, usuário sem permissão para editar grupos.','Sem Permissão','I',[mbOk]);
end;
...
begin
  ...
  TfrmMenssagens.Mensagem('Desculpe, usuário sem permissão para Excluir grupos','Sem Permissão','I',[mbOk]);
end;
...
begin
  ...
  TfrmMenssagens.Mensagem('Desculpe, usuário sem permissão para Inserir Grupos.','Sem Permissão','I',[mbOk]);
end;
