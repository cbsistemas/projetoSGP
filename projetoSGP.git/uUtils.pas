...
Type
  ...
  public
    ...
    procedure EfeitoAumenta(Sender:TObject);
    procedure EfeitoDiminui(Sender:TObject);
  published
...
procedure TUtils.EfeitoAumenta(Sender: TObject);
begin
  (Sender as TImage).Width := (Sender as TImage).Width + 10;
  (Sender as TImage).Height := (Sender as TImage).Height + 10;
  (Sender as TImage).Left := (Sender as TImage).Left - 5;
  (Sender as TImage).Top := (Sender as TImage).Top - 5;
end;

procedure TUtils.EfeitoDiminui(Sender: TObject);
begin
  (Sender as TImage).Width := (Sender as TImage).Width - 10;
  (Sender as TImage).Height := (Sender as TImage).Height - 10;
  (Sender as TImage).Left := (Sender as TImage).Left + 5;
