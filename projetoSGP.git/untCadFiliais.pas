...
type
  TfrmCadFiliais = class(TForm)
    ...
    RzDBEdit3: TRzDBEdit;
    RzLabel3: TRzLabel;
    fdsFiliaisCIDADE: TFIBStringField;
    fdsFiliaisUF: TFIBStringField;
    fdsFiliaisIDROTA: TFIBBCDField;
...
procedure TfrmCadFiliais.btnPesqCidadeClick(Sender: TObject);
begin
  Try
  ...
  Finally
    ...
    begin
      fdsFiliaisIDCIDADE.AsInteger := frmPesqCidade.fdsCidadesID.AsInteger;
