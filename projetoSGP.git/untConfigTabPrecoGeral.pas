...
begin
  ...
  Case MessageBox(Application.Handle,
    Pchar('Deseja realmente Confirmar a alteração nas tabelas de preço?'),
    ...
    idYes:
      begin
        ...
        DM.Conexao.CommitRetaining;
        //AtualizaPrecos;
        Application.MessageBox('Atualização de preços realizada com sucesso.',
...
begin
  ...
  begin
    Application.MessageBox('Informe uma descrição para o Preço 1 da tabela.',
