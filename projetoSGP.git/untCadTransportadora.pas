...
begin
  Case MessageBox(Application.Handle,
    Pchar('Deseja realmente cancelar a Iclusão/Alteração desta transportadora?'),
...
begin
  ...
  begin
    Case MessageBox(Application.Handle,
      Pchar('Deseja realmente apagar este veículo?'), 'Atenção',
...
begin
  ...
  begin
    Application.MessageBox
      ('Salve ou Cancele a Inclusão/Alteração da Transportadora antes de sair.',
