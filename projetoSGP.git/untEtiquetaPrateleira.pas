...
begin
  cbxQtnPadao.Hint:='Ao marcar esta opção, não será considerada a'+#13+'quantidade de etiquetas de cada item.'+#13+'No entanto, será impresso a quantidade padrão'+#13+'escolhida para cada item.'
end;
