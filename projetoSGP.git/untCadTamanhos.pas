...
begin
  ...
  begin
    Case MessageBox(Application.Handle,
      Pchar('Deseja realmente retirar o Grupo atual deste Tamanho?'), 'Atenção',
      MB_YESNO + MB_ICONQUESTION + MB_DEFBUTTON2) of
      idYes:
        begin
...
begin
  ...
  begin
    ...
    imgPrincipal.Picture.LoadFromFile(ExtractFilePath(Application.ExeName) +
      '\content\Aplicacao_AutoPecas_64x64.png');
  end;
end;
...
begin
  Try
    ...
    begin
      if frmSelectGrupos.cdsGrupo.Locate('ID',
        fdsTamanho_GrupoIDGRUPO.AsString, []) then
      begin
    ...
    fdsTamanho_Grupo.First;
    frmSelectGrupos.cdsGrupo.First;
