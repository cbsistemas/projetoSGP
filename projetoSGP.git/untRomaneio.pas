...
begin
  ...
  { Case MessageBox(Application.Handle, Pchar('Deseja faturar e imprimir as vendas agora?'), 'Atenção', MB_YESNO + MB_ICONQUESTION + MB_DEFBUTTON2) of
    idYes: begin
    fecharPedidos := True;
    end;
    end; }
  ...
  begin
    ...
    begin
      ...
      { Case MessageBox(Application.Handle, Pchar('Houve alguma pendência no pedido: PD' + idPedido + ' da filial nº ' + idFilialPedido + ' ?'), 'Atenção', MB_YESNO + MB_ICONQUESTION + MB_DEFBUTTON2) of
        idYes: begin
    ...
    msgFinal := msgFinal + ' Não se esqueça de fechar cada pedido manualmente.';
  ...
  begin
    ...
    begin
      Application.MessageBox
        ('Você não pode gravar um Romaneio sem pedidos para entrega.',
        'Anteção', MB_OK + MB_ICONERROR);
      btnPedidoIncluir.SetFocus;
      Abort;
    end;

    // Retorna todos os Itens do romaneio caso ele já exista
    ...
    begin
      // Verifica se teve algum item excluído
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          begin
            Case MessageBox(Application.Handle,
              Pchar('Carga máxima ultrapassada.Deseja incluir o pedido assim mesmo?'),
              'Atenção', MB_YESNO + MB_ICONQUESTION + MB_DEFBUTTON2) of
              IDNO:
                begin
                  incluirItem := False;
          ...
          begin
            ...
            begin
              Application.MessageBox
                ...
                + ' já está incluso neste Romaneio.'), 'Anteção',
                MB_OK + MB_ICONERROR);
              pesoTotal := pesoTotal - frmPesqEntregar.cdsEntregarPESO.AsFloat;
            end
            else
...
begin
  { with fdsPedidoItens do
    ...
    Conditions.Clear;
    Conditions.Apply;
    SelectSQL.Clear; //Deixar assim pois o fastreport não quer reconhecer "conditions"
