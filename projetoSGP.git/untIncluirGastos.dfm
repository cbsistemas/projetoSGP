object frmIncluirGastos: TfrmIncluirGastos
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Inclus'#227'o de Gastos'
  ClientHeight = 321
  ClientWidth = 611
  Color = clBtnFace
  ...
  object RzPanel2: TRzPanel
    ...
    object dtpDtPagamento: TRzDateTimeEdit
      Left = 128
      Top = 29
      Width = 121
      Height = 21
    ...
    object RzDBLookupComboBox1: TRzDBLookupComboBox
      ...
      Height = 21
      Color = clMoneyGreen
      DataField = 'IDPLANO_CONTA'
      DataSource = dsCntPagar
      KeyField = 'ID'
      ListField = 'NOME'
      ListSource = dsPlanoConta
      TabOrder = 6
    end
  end
  ...
  object dsCntPagar: TDataSource
    AutoEdit = False
    DataSet = fdsCntPagar
    Left = 263
    Top = 55
  end
  object fdsCntPagarItem: TpFIBDataSet
    UpdateSQL.Strings = (
      ...
      '    PAG_DESC_ACRE = :PAG_DESC_ACRE,'
      '    PAG_DINHEIRO = :PAG_DINHEIRO,'
      '    ID_PAG_ITEM = :ID_PAG_ITEM,'
    ...
    Left = 343
    Top = 7
    object fdsCntPagarItemID: TFIBBCDField
      FieldName = 'ID'
      Size = 0
    end
    object fdsCntPagarItemIDFILIAL: TFIBBCDField
      FieldName = 'IDFILIAL'
      Size = 0
    end
    object fdsCntPagarItemPOSICAO: TFIBStringField
      FieldName = 'POSICAO'
      Size = 2
      Transliterate = False
      EmptyStrToNull = True
    end
    object fdsCntPagarItemPREFIXO: TFIBStringField
      FieldName = 'PREFIXO'
      Size = 2
      Transliterate = False
      EmptyStrToNull = True
    end
    object fdsCntPagarItemREFERENCIA: TFIBStringField
      FieldName = 'REFERENCIA'
      Size = 12
      Transliterate = False
      EmptyStrToNull = True
    end
    object fdsCntPagarItemIDPAGAR: TFIBBCDField
      FieldName = 'IDPAGAR'
      Size = 0
    end
    object fdsCntPagarItemDT_VENC: TFIBDateField
      FieldName = 'DT_VENC'
    end
    object fdsCntPagarItemDT_PAG: TFIBDateField
      FieldName = 'DT_PAG'
    end
    object fdsCntPagarItemACRESCIMO: TFIBBCDField
      FieldName = 'ACRESCIMO'
      Size = 8
    end
    object fdsCntPagarItemDESCONTO: TFIBBCDField
      FieldName = 'DESCONTO'
      Size = 8
    end
    object fdsCntPagarItemVALOR: TFIBBCDField
      FieldName = 'VALOR'
      Size = 8
    end
    object fdsCntPagarItemVALOR_PAGO: TFIBBCDField
      FieldName = 'VALOR_PAGO'
      Size = 8
    end
    object fdsCntPagarItemHISTORICO: TFIBStringField
      FieldName = 'HISTORICO'
      Size = 200
      Transliterate = False
      EmptyStrToNull = True
    end
    object fdsCntPagarItemPARCELA: TFIBStringField
      FieldName = 'PARCELA'
      Size = 6
      Transliterate = False
      EmptyStrToNull = True
    end
    object fdsCntPagarItemENVIADO_WEB: TFIBStringField
      FieldName = 'ENVIADO_WEB'
      Size = 1
      Transliterate = False
      EmptyStrToNull = True
    end
    object fdsCntPagarItemNUM_DOCUMENTO: TFIBStringField
      FieldName = 'NUM_DOCUMENTO'
      Transliterate = False
      EmptyStrToNull = True
    end
    object fdsCntPagarItemBAIXA_AGRUPADA: TFIBStringField
      FieldName = 'BAIXA_AGRUPADA'
      Size = 1
      Transliterate = False
      EmptyStrToNull = True
    end
    object fdsCntPagarItemPAGAMENTO_MOEDA: TFIBStringField
      FieldName = 'PAGAMENTO_MOEDA'
      Size = 2
      Transliterate = False
      EmptyStrToNull = True
    end
    object fdsCntPagarItemPAG_DESC_ACRE: TFIBBCDField
      FieldName = 'PAG_DESC_ACRE'
      Size = 8
    end
    object fdsCntPagarItemPAG_DINHEIRO: TFIBBCDField
      FieldName = 'PAG_DINHEIRO'
      Size = 8
    end
    object fdsCntPagarItemID_PAG_ITEM: TFIBBCDField
      FieldName = 'ID_PAG_ITEM'
      Size = 0
    end
    object fdsCntPagarItemREC_DINHEIRO: TFIBBCDField
