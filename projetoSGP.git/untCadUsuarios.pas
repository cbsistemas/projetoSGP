...
begin
  ...
  begin
   ...
   TfrmMenssagens.Mensagem('Desculpe, usuário sem permissão para Alterar cadastros de Usuários.','Sem Permissão','I',[mbOk]);
end;
...
begin
  ...
  begin
    Application.MessageBox('Nome e Login obrigatórios.', 'Atenção',
  ...
  begin
    ...
    begin
      Application.MessageBox('Senha e confirmação de senha Obrigatório.',
 ...
 DM.Conexao.CommitRetaining;
  GravaCancela;
  Application.MessageBox('As Alterções feitas só estarão disponíveis na próxima vez que o usuário alterado fizer login.', 'Atenção',
...
begin
  ...
  begin
    ...
    TfrmMenssagens.Mensagem('Desculpe, usuário sem permissão para Inserir Usuários.','Sem Permissão','I',[mbOk]);
end;
...
//  fdsUsuarioPermicSGPEXIBIR_PEDIDOS_DIA.AsString :=RetornaSouN(cktConfigSGP.Items[0].Item[17].Item[1].StateIndex);
 ...
 // cktConfigSGP.Items[0].Item[0].Item[2].StateIndex:=Retorna1ou2(fdsUsuarioPermicSGP.AsString);     ESPECÍFICO PARA ENTREGA
