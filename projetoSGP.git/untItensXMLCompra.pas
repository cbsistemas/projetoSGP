      ...
      Finally
        ...
        begin
          ...
          begin
            ...
            informacao:='Preço:R$'+frmPesqProdutoItens.fdsProdutoItensPREC_VENDA.AsString+' Preço de Custo:R$'+frmPesqProdutoItens.fdsProdutoItensPREC_CUSTO.AsString+' Custo Médio:R$'+frmPesqProdutoItens.fdsProdutoItensPREC_CUSTO_MEDIO.AsString;
            Post;
          end;
        end;
