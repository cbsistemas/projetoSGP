...
//Caso não tenha, criar forma de controle de dias sem Internet
end;
...
begin
  Try
    try
      ...
      //colocar uma verificação se vai ou não validar a chave pela internet
     // AtualizaChave; //Verifica a chave do sistema pela Internet;

      ControleRegistro; // valida chave do sistema: Se está valida ou não
