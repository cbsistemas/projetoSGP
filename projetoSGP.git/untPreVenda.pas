...
begin
  ...
  begin
    Case MessageBox(Application.Handle,
      Pchar('Deseja realmente abandonar a venda?'), 'Atenção',
...
begin
  ...
  begin
    Case MessageBox(Application.Handle,
      Pchar('Deseja realmente excluir essa venda?'), 'Atenção',
      MB_YESNO + MB_ICONQUESTION + MB_DEFBUTTON2) of
      idYes:
        begin
...
begin
  ...
  begin
    Application.MessageBox
      ('Salve ou Cancele a Inclusão/Alteração antes de sair.', 'Atenção',
    ...
    begin
      ...
      Finally
        ...
        begin
          ...
          // vitor ver sobre tabela de preço
...
begin
  ...
  begin
    ...
    begin
      Application.MessageBox
        (Pchar('Desconto máximo permitido para esse item é: ' +
        FloatToStr(vlrDescMax) + '%'), 'Desconto não permitido.',
        MB_OK + MB_ICONERROR);
    ...
    begin
      Application.MessageBox
        ('Desculpe, você não tem permissão para ultrapassar o desconto máximo',
        'Desconto não permitido.', MB_OK + MB_ICONERROR);
      edtItemDesconto.SetFocus;
      Abort;
    end;
  end
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Application.MessageBox('Código de vendedor inválido.', 'Atenção',
          MB_OK + MB_ICONWARNING);
      end
      else
        fdsPreVendaVENDEDOR.AsString := fdsVendedorNOME.AsString;
