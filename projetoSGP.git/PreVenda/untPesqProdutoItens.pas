...
type
  TfrmPesqProdutoItens = class(TForm)
    ...
    fdsProdutoItensMARGEM_LUCRO_TAB2: TFIBBCDField;
    fdsProdutoItensMARGEM_LUCRO_TAB3: TFIBBCDField;
    fdsProdutoItensMARGEM_LUCRO_TAB4: TFIBBCDField;
    fdsProdutoItensMARGEM_LUCRO_TAB5: TFIBBCDField;
    fdsProdutoItensMARGEM_LUCRO_TAB6: TFIBBCDField;
  ...
  begin
    ...
    begin
      selecionouTabela := False;
       ...
       if frmPrincipal.cdstabPrecoTempTAB_PRECO.AsInteger=1 then
      begin
      ...
      if frmPrincipal.cdstabPrecoTempTAB_PRECO.AsInteger=2 then
      begin
...
//
      if frmPrincipal.cdstabPrecoTempTAB_PRECO.AsInteger=3 then
      begin
      ...
      if frmPrincipal.cdstabPrecoTempTAB_PRECO.AsInteger=4 then
      begin
...
begin
  ...
  begin
    ...
    begin
      ...
      gdrItens.Columns[4].Title.Caption:='Tab.Preço 1';
    end
    else
     gdrItens.Columns[4].Visible := false;
    ...
    begin
      ...
      gdrItens.Columns[5].Title.Caption:='Tab.Preço 2';
    end
    else
     gdrItens.Columns[5].Visible :=false;
    ...
    begin
      ...
      gdrItens.Columns[6].Title.Caption:='Tab.Preço 3';
    end
    else
     gdrItens.Columns[6].Visible := False;
    ...
    begin
      ...
      gdrItens.Columns[7].Title.Caption:='Tab.Preço 4';
    end
    else
      gdrItens.Columns[7].Visible := false;

    if frmPrincipal.cdstabPrecoTempTAB_PRECO.AsInteger=5 then
    begin
      gdrItens.Columns[8].Visible := True;
      gdrItens.Columns[8].Title.Caption:='Tab.Preço 5';
    end
    else
      gdrItens.Columns[8].Visible := false;

    if frmPrincipal.cdstabPrecoTempTAB_PRECO.AsInteger=6 then
    begin
      gdrItens.Columns[9].Visible := True;
      gdrItens.Columns[9].Title.Caption:='Tab.Preço 4';
    end
    else
     gdrItens.Columns[9].Visible := false;
  end;
...
begin
  ...
  begin
    ...
    //gdrItens.Canvas.Font.Color := clBlue;
