...
begin
  ...
  begin
    Application.MessageBox('Você não pode gravar uma Produção sem itens.',
      'Anteção', MB_OK + MB_ICONERROR);
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Application.MessageBox('Funcionário não encontrado.', 'Anteção',
          MB_OK + MB_ICONERROR);
        Abort;
      end;
    end
    ...
    begin
      Application.MessageBox('Informe um Funcionário no painel de pesquisa.',
        'Anteção', MB_OK + MB_ICONERROR);
      Abort;
    end;
...
begin
  ...
  Finally
    ...
    begin
      ...
      begin
        Application.MessageBox
          ('Este item já foi incluso no Pedido, você não pode duplicá-lo!',
