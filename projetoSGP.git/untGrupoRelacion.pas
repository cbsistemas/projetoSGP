...
begin
  ...
  Case MessageBox(Application.Handle,
    Pchar('Deseja realmente abandonar o relacionamento de grupos?'), 'Atenção',
...
begin
  ...
  begin
    ...
    R := Rect;
    InflateRect(R, -1, -1);
    DrawFrameControl(gdrCor.Canvas.Handle, R, DFC_BUTTON,
...
begin
  ...
  begin
    ...
    R := Rect;
    InflateRect(R, -1, -1);
    DrawFrameControl(gdrTamanho.Canvas.Handle, R, DFC_BUTTON,
      DFCS_BUTTONCHECK or Check);
  end;
end;
