object frmEntregaDados: TfrmEntregaDados
  Left = 0
  Top = 0
  Anchors = [akLeft, akTop, akRight, akBottom]
  BorderIcons = []
  BorderStyle = bsToolWindow
  Caption = 'Informe os dados do local de Entrega'
  ClientHeight = 245
  ClientWidth = 542
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object edtCodCidade: TRzDBEdit
      Left = 150
      Top = 121
      Width = 57
      Height = 21
      DataSource = frmNfe.dsNFe
      DataField = 'ENTREG_CIDADE_CODIGO'
      Color = clMoneyGreen
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
