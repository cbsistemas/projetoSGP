object frmPagIncReceber: TfrmPagIncReceber
  Left = 0
  Top = 0
  Anchors = [akTop, akRight]
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Baixa de Documentos - Contas a Receber'
  ClientHeight = 584
  ClientWidth = 729
  Color = clBtnFace
  ...
  object RzPanel1: TRzPanel
    ...
    object lblTitulo: TRzLabel
      ...
      Width = 218
      Height = 18
      Caption = 'Inclus'#227'o de Nota de Cliente'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
  ...
  object qryEditCntReceber_Item: TpFIBQuery
    Transaction = DM.transPricipal
    Database = DM.Conexao
    SQL.Strings = (
      'UPDATE CNT_RECEBER_ITEM SET'
      'POSICAO = :POSICAO,'
      'DT_PAG = :DT_PAG, '
      ...
      'VALOR_JUROS_PAGO = VALOR_JUROS_PAGO + :VALOR_JUROS_PAGO,'
      'VLR_JUROS_RESTANTE = :VLR_JUROS_RESTANTE,'
      'REC_DESC_ACRE = :REC_DESC_ACRE,'
      'VLR_RENEGOCIADO = :VLR_RENEGOCIADO'
      ''
      '  WHERE'
      '        ID = :ID'
      '  AND'
  ...
  object qryEditChequeCntReceber_Item: TpFIBQuery
    Transaction = DM.transPricipal
    Database = DM.Conexao
    SQL.Strings = (
      'UPDATE CNT_RECEBER_CHEQUE SET'
      'IDBANCO = :IDBANCO,'
      'AGENCIA = :AGENCIA,'
      'CONTA = :CONTA,'
  ...
  object cdsDocumentos: TpFIBClientDataSet
    ...
    object cdsDocumentosVALOR_PAGO_ATUAL: TFloatField
      FieldName = 'VALOR_PAGO_ATUAL'
    end
    object cdsDocumentosVALOR_RESTANTE: TFloatField
      FieldName = 'VALOR_RESTANTE'
    end
    object cdsDocumentosDESCONTO_PARCIAL: TFloatField
      FieldName = 'DESCONTO_PARCIAL'
    end
    object cdsDocumentosACRESCIMO_PARCIAL: TFloatField
      FieldName = 'ACRESCIMO_PARCIAL'
    end
    object cdsDocumentosVLR_JUROS_PAGO: TFloatField
      FieldName = 'VLR_JUROS_PAGO'
    end
    object cdsDocumentosJUROS_RESTANTE: TFloatField
      FieldName = 'JUROS_RESTANTE'
    end
    object cdsDocumentosTEMP_JUROS_RESTANTE: TStringField
      FieldName = 'TEMP_JUROS_RESTANTE'
      Size = 2
    end
    object cdsDocumentosVLR_RENEGOCIADO: TFloatField
      FieldName = 'VLR_RENEGOCIADO'
    end
    object cdsDocumentosVLR_ENTRADA: TFloatField
      FieldName = 'VLR_ENTRADA'
    end
  end
  object fdsReceber_Pagamento: TpFIBDataSet
    DeleteSQL.Strings = (
      'DELETE FROM'
      '    CNT_RECEBER_PAGAMENTO'
      'WHERE'
      '        IDCONTA = :OLD_IDCONTA'
      ...
      '    ')
    InsertSQL.Strings = (
      'INSERT INTO CNT_RECEBER_PAGAMENTO('
      '    IDCONTA,'
      '    IDPAGAMENTO,'
      '    IDFILIAL'
      ')'
    ...
    Database = DM.Conexao
    Left = 672
    object fdsReceber_PagamentoIDCONTA: TFIBBCDField
      FieldName = 'IDCONTA'
      Size = 0
    end
    object fdsReceber_PagamentoIDPAGAMENTO: TFIBBCDField
      FieldName = 'IDPAGAMENTO'
      Size = 0
    end
    object fdsReceber_PagamentoIDFILIAL: TFIBBCDField
      FieldName = 'IDFILIAL'
      Size = 0
    end
  end
  object cdsRec_Pag: TpFIBClientDataSet
    Aggregates = <>
    Params = <>
    Left = 656
    Top = 55
    object cdsRec_PagIDFILIAL: TIntegerField
      FieldName = 'IDFILIAL'
    end
    object cdsRec_PagIDCONTA: TIntegerField
      FieldName = 'IDCONTA'
    end
    object cdsRec_PagIDPAGAMENTO: TIntegerField
      FieldName = 'IDPAGAMENTO'
    end
    object cdsRec_PagPREFIXO_PAGAMENTO: TStringField
