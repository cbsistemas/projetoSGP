...
begin
  if uVerificaPermicao.Verifica('CAD_CLIENTE_EXCL') = true then
   ...
   TfrmMenssagens.Mensagem('Desculpe, Usuário sem permissão para Excluir clientes.','Sem permissão.','I',[mbOk]);
end;
...
begin
  ...
  then
    raise exception.create('Arquivo não encontrato:' +
...
begin
  ...
  begin
   ...
   begin
    TfrmMenssagens.Mensagem('Desculpe,Usuário sem permissão para alterar crédito de clientes.','Sem permissão.','I',[mbOk]);
