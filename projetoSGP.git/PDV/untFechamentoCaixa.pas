...
type
  TfrmFechamentoCaixa = class(TForm)
    ...
    RzLabel10: TRzLabel;
    RzDBEdit8: TRzDBEdit;
    fdsCaixaFechamentoVLR_CARTAO: TFIBBCDField;
    fdsCaixaFechamentoVLR_NOTA: TFIBBCDField;
    fdsCaixaFechamentoVLR_TROCO: TFIBBCDField;
...
Try
   ...
   Finally
      ...
      begin
        ...
        fdsMovimentoCaixaCONTROLE.AsInteger := StrToInt(DM.fdsCaixaCONTROLE.AsString);
...
begin
  ...
  begin
    ...
    fdsCaixaFechamentoCONTROLE.AsInteger := StrToInt(DM.fdsCaixaCONTROLE.AsString);
  end;
end;
...
begin
    ...
    redImprimir.Lines.Add(' Data: ' + DateToStr(Now) + ' Hora: ' + TimeToStr(Now) + ' Caixa: ' + IntToStr(DM.numCaixa) + ' Controle: ' + DM.fdsCaixaCONTROLE.AsString);
    ...
    redImprimir.Lines.Add('');
    redImprimir.Lines.Add(' CARTÃO: ' + FormatCurr('R$ #,##0.00', fdsCaixaFechamentoVLR_CARTAO.AsFloat));
    redImprimir.Lines.Add('');
    redImprimir.Lines.Add(' NOTA: ' + FormatCurr('R$ #,##0.00', fdsCaixaFechamentoVLR_NOTA.AsFloat));
    redImprimir.Lines.Add('');
    redImprimir.Lines.Add(' TROCO: ' + FormatCurr('R$ #,##0.00', fdsCaixaFechamentoVLR_TROCO.AsFloat));
    redImprimir.Lines.Add('');
    redImprimir.Lines.Add('------------------------------------------');
    redImprimir.Lines.Add('');
    redImprimir.Lines.Add('');
