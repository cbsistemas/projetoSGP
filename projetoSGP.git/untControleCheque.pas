...
procedure TfrmControleCheque.rgbReferenciaCheckBoxClick(Sender: TObject);
begin
...
procedure TfrmControleCheque.edtPesqRefEnter(Sender: TObject);
begin
...
procedure TfrmControleCheque.edtPesqRefExit(Sender: TObject);
begin
...
procedure TfrmControleCheque.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
  frmControleCheque := nil;
end;
...
begin
  ...
  setwindowrgn(handle, region, true);} //Arredonda canto do formulário
  fdsFilial.Open;
  fdsCntCheque.Open;
  cdsCntCheque.Open;
