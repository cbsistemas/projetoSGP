...
begin
  Case MessageBox(Application.Handle,
    Pchar('Confirma o pagamento desta comissão?'), 'Atenção',
    ...
    idYes:
      begin
        ...
        fdsComissaoVend.Post;
        DM.Conexao.CommitRetaining;
        Application.MessageBox('Comissão paga com sucesso!', 'Sucesso',
...
begin
  ...
  begin
    ...
    begin
      ...
      // vitor O desconto da venda terá que ser rateado como desconto do item, e o desconto no recebimento da nota tbm, depois multiplicar pelo valor da comissão baseado na moeda de pagamento
      SQL.Add(' FROM V_VENDA_PEDIDO_ITEM VVPI, V_VENDA_PEDIDO VVP, PRODUTO_ITEM PI');
