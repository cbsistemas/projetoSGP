object frmBaixaDocumento: TfrmBaixaDocumento
  Left = 0
  Top = 0
  Anchors = [akTop, akRight]
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Baixa de Documento'
  ClientHeight = 511
  ClientWidth = 729
  Color = clBtnFace
  ...
  object fdsPortador: TpFIBDataSet
    SelectSQL.Strings = (
      'SELECT'
      '    ID,'
      '    DESCRICAO'
    ...
    Left = 136
    oFetchAll = True
    object fdsPortadorID: TFIBBCDField
      FieldName = 'ID'
      Size = 0
    end
    object fdsPortadorDESCRICAO: TFIBStringField
      FieldName = 'DESCRICAO'
      Size = 100
      Transliterate = False
      EmptyStrToNull = True
  ...
  object fdsReceber_Pagamento: TpFIBDataSet
    ...
    RefreshSQL.Strings = (
      ...
      ''
      ' WHERE '
      '        CNT_RECEBER_PAGAMENTO.IDCONTA = :OLD_IDCONTA'
      '    and CNT_RECEBER_PAGAMENTO.IDPAGAMENTO = :OLD_IDPAGAMENTO'
      '    and CNT_RECEBER_PAGAMENTO.IDFILIAL = :OLD_IDFILIAL'
      '    ')
    SelectSQL.Strings = (
      'SELECT'
      '    *'
  ...
  object frxDocumentos: TfrxDBDataset
    ...
    FieldAliases.Strings = (
      ...
      'REFERENCIA=REFERENCIA'
      'IdVenda=IDVENDA'
      'VALOR_PAGO_ATUAL=VALOR_PAGO_ATUAL'
