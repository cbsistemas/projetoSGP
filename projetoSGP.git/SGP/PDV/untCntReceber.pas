          ...
          begin
            try
              ...
              DM.valor :=FloatToStr((frmBaixaDocumento.valorDinheiro +frmBaixaDocumento.valorCheque + frmBaixaDocumento.valorCartao)
                 - (frmBaixaDocumento.troco));      //retirei o valor do crédito pois o Eraldo reclamou.
              recebimento := True;
              DM.dtInicio:= now;
               ...
               begin
                 ...
                 Append;
                  ...
                  fdsMovCntReceberVLR_TOT_RECEBIDO.AsFloat :=(fdsMovimentoCaixaVLR_CARTAO.AsFloat +fdsMovimentoCaixaVLR_CHEQUE.AsFloat + fdsMovimentoCaixaVLR_NOTA.AsFloat+fdsMovimentoCaixaVLR_ENTRADA.AsFloat); //retirei o valor do crédito pois o Eraldo reclamou.
 ...
 begin
  ...
  begin
    ...
    cdsFormaPagamentoVALOR.AsFloat :=
        ...
        + fdsMovCntReceberVLR_DINHEIRO.AsFloat);  //retirei o valor do crédito pois o Eraldo reclamou.
    Post;
