...
type
  TfrmCadClientes = class(TForm)
    ...
    DBMemo1: TDBMemo;
    DBMemo2: TDBMemo;
    fdsClientesCODCIDADE: TFIBStringField;
...
begin
  if Trim(fdsClientesIE.AsString).IsEmpty then
   ...
   if Trim(fdsClientesIDCIDADE.AsString).IsEmpty then
   begin
   Application.MessageBox('Innforme Uma cidade.','Anteção',MB_OK+MB_ICONERROR);
   abort;
   end;
