...
begin
  ...
  begin
   // Application.MessageBox('Desculpe, Usuário sem permissão para realizar suprimentos.', 'Sem permissão.', MB_OK+MB_ICONERROR);
    TFrmMensagens.Mensagem('Desculpe, Usuário sem permissão para realizar suprimentos.', 'Sem permissão.', 'I',[mbOK]);
    try
  ...
  begin
    ...
    TFrmMensagens.Mensagem('Desculpe, Usuário sem permissão para realizar suprimentos.', 'Sem permissão.', 'I',[mbOK]);
    //Application.MessageBox('Desculpe,Usuário sem permissão para realizar suprimento', 'Sem permissão.', MB_OK+MB_ICONERROR);
end;
...
begin
  temPermicao := False;
    ...
    if DM.fdsUsuarioPermicVER_MOVIMENTO.AsString = 'N' then
     begin
      //  Application.MessageBox('Desculpe, você não tem permição para entrar em Movimentação', ' não Permitido.', MB_OK+MB_ICONERROR);
        TFrmMensagens.Mensagem('Desculpe, você não tem permissão para entrar em Movimentação.', 'Sem permissão para ver Movimentação.', 'I',[mbOK]);
        try
         frmLogin := TfrmLogin.Create(nil);
         frmLogin.ShowModal;
        finally
...
begin
  ...
  begin
    ...
    TFrmMensagens.Mensagem('Desculpe, você não tem permissão para realizar sangria.', 'Sem permissão.', 'I',[mbOK]);
    try
         frmLogin := TfrmLogin.Create(nil);
         frmLogin.ShowModal;
        finally
