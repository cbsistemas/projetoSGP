...
type
  ...
  public
    var
      valorFinanceira, valorValeDesconto, valorTicket, valorCredito: Double;
  end;
...
procedure TfrmOutrosPagamentos.edtCreditoEnter(Sender: TObject);
var
  utils : TUtils;
begin
...
procedure TfrmOutrosPagamentos.edtCreditoExit(Sender: TObject);
var
  utils : TUtils;
begin
...
var
  utils : TUtils;
begin
  edtFinanceira.Text := FloatToStr(utils.ValidaInteiroFloat(edtFinanceira.Text, 'F'));
...
var
  utils : TUtils;
begin
  edtValeDesconto.Text := FloatToStr(utils.ValidaInteiroFloat(edtValeDesconto.Text, 'F'));
...
var
  utils : TUtils;
begin
  edtFinanceira.Text := utils.AdicionaMascaraDinheiro(FloatToStr(valorFinanceira));
  edtValeDesconto.Text := utils.AdicionaMascaraDinheiro(FloatToStr(valorValeDesconto));
  edtTicket.Text := utils.AdicionaMascaraDinheiro(FloatToStr(valorTicket));
  edtCredito.Text := utils.AdicionaMascaraDinheiro(FloatToStr(valorCredito));
end;
